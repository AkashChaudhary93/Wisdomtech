    ...
    <section className="py-24 relative z-10 px-4 max-w-7xl mx-auto -mt-16">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="md:col-span-4 h-full">
          <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.02} transitionSpeed={2500} glareEnable={true} glareMaxOpacity={0.05} className="h-full">
            <div className="glass-heavy p-8 relative overflow-hidden group h-full">
        ...
        <div className="md:col-span-8 flex flex-col gap-6">
          <div className="grid md:grid-cols-2 gap-6 flex-1">
            ...
            <motion.div variants={itemVariants} className="h-full">
              <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.02} transitionSpeed={2500} className="h-full">
                <div className="glass p-8 group hover:shadow-2xl transition-all duration-300 h-full">
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-3 gap-6">
            ...
            <Tilt tiltMaxAngleX={15} tiltMaxAngleY={15} scale={1.05} transitionSpeed={2500}>
              <div className="glass p-5 rounded-2xl flex items-center justify-between group cursor-pointer hover:shadow-xl transition-all overflow-hidden relative">
